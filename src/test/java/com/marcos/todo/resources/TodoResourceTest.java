...
class TodoResourceTest {
    ...
    private static final String NOMEDOCLIENTE = "Marcos";
    ...
    void whenFindByIdThenReturnSuccess() {
        ...
        assertEquals(NOMEDOCLIENTE, response.getBody().getNomeDoCliente());
    ...
    void whenFindAllThenReturnAListOfTodoDto() {
        ...
        assertEquals(NOMEDOCLIENTE, response.getBody().get(INDEX).getNomeDoCliente());
